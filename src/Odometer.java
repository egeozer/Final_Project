...
public class Odometer implements TimerListener {
	...
	// constructor
	public Odometer (EV3LargeRegulatedMotor leftMotor, EV3LargeRegulatedMotor rightMotor, int INTERVAL, boolean autostart, int startPos) {
