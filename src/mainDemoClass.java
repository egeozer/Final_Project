...
public class mainDemoClass {
	...
	private static final Port usPortCenter = LocalEV3.get().getPort("S1");	// first us sensor	
	private static final Port usPortRight = LocalEV3.get().getPort("S4");
	private static final Port colorPortRight = LocalEV3.get().getPort("S2");	// first light sensor
	...
	public static void main(String[] args) {
		...
		SensorModes usSensor = new EV3UltrasonicSensor(usPortCenter);
		...
		SensorModes colorSensor = new EV3ColorSensor(colorPortRight);
